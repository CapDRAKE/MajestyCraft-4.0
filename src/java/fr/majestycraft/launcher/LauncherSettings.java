...
public class LauncherSettings extends IScreen {
    ...
    public LauncherSettings(final Pane root, final GameEngine engine, final LauncherPanel pane) {
        ...
        List<String> disabledForgeVersions = Arrays.asList("1.8", "1.19.2", "1.19.3", "1.19.4", "1.20", "1.20.1", "1.20.2", "1.20.3", "1.20.4", "1.20.5", "1.20.6", "1.21", "1.21.1", "1.21.2", "1.21.3", "1.21.4", "1.21.5", "1.21.6", "1.21.7", "1.21.8");
        List<String> disabledOptifineVersions = Arrays.asList("1.8", "1.20.2", "1.20.3", "1.20.4", "1.20.5", "1.20.6", "1.21", "1.21.2", "1.21.5");
        ...
        this.versionList.setOnAction(event -> {
            ...
            boolean isForgeRestricted = "1.8".equals(version) || "1.19.2".equals(version) || "1.19.3".equals(version) || "1.19.4".equals(version) || "1.20".equals(version) || "1.20.1".equals(version) || "1.20.2".equals(version) || "1.20.3".equals(version) || "1.20.4".equals(version) || "1.20.5".equals(version) || "1.20.6".equals(version) || "1.21".equals(version) || "1.21.1".equals(version) || "1.21.2".equals(version) || "1.21.3".equals(version) || "1.21.4".equals(version) || "1.21.5".equals(version) || "1.21.6".equals(version) || "1.21.7".equals(version) || "1.21.8".equals(version);
            boolean isOptifineRestricted = "1.8".equals(version) || "1.20.2".equals(version) || "1.20.3".equals(version) || "1.20.4".equals(version) || "1.20.5".equals(version) || "1.20.6".equals(version) || "1.21".equals(version) || "1.21.2".equals(version) || "1.21.5".equals(version);
