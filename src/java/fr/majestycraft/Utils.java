...
public class Utils {
	...
	public static void regGameStyle(GameEngine engine, LauncherConfig config) {
	    ...
	    switch (version) {
	        ...
	        case "1.11.2":
	        case "1.12.2":
	            engine.setGameStyle(useForge ? GameStyle.FORGE_1_8_TO_1_12_2 : GameStyle.VANILLA);
	            break;
	        case "1.13.2":
	        case "1.14.4":
	        case "1.15.2":
	        ...
	        case "1.16.4":
	        case "1.16.5":
	            engine.setGameStyle(useForge ? GameStyle.FORGE_1_13_HIGHER : GameStyle.VANILLA);
	            break;
	        case "1.17":
	        case "1.17.1":
	        case "1.18":
	        case "1.18.1":
	        case "1.18.2":
	            engine.setGameStyle(useForge ? GameStyle.FORGE_1_17_HIGHER : GameStyle.VANILLA);
	            break;
	        case "1.19":
	        case "1.19.1":
	        case "1.19.2":
